...
function Icon({ id, active }: { id: string; active: boolean }) {
  ...
  if (active) {
    ...
    if (id === 'wallet')   return <svg {...f} fillRule="evenodd" clipRule="evenodd"><path d="M6 5.5h10.4A3.6 3.6 0 0 1 20 9.1v1.4h1.2a1.6 1.6 0 0 1 1.6 1.6v1.6a1.6 1.6 0 0 1-1.6 1.6H20v1.7a3.6 3.6 0 0 1-3.6 3.6H6A3.6 3.6 0 0 1 2.4 18V9.1A3.6 3.6 0 0 1 6 5.5Zm14.85 6.05a1 0.72 0 1 0 0 1.9 1 0.72 0 1 0 0-1.9Z" /></svg>;
  ...
  if (id === 'wallet')   return <svg {...s}><path d="M6 5.5h10.4A3.6 3.6 0 0 1 20 9.1v1.4h1.2a1.6 1.6 0 0 1 1.6 1.6v1.6a1.6 1.6 0 0 1-1.6 1.6H20v1.7a3.6 3.6 0 0 1-3.6 3.6H6A3.6 3.6 0 0 1 2.4 18V9.1A3.6 3.6 0 0 1 6 5.5Z" /><path d="M6.5 9h9" /><ellipse cx="20.9" cy="12.5" rx="0.95" ry="0.7" fill={color} stroke="none" /></svg>;
