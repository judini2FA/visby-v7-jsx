...
// Transparent cutouts are stored as .png, trimmed to the subject on upload; render them `contain` so
// the whole item shows uncropped while filling the frame at the same size as a normal product photo.
